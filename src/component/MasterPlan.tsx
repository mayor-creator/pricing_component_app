  ...
  return (
    <MasterPlan>
      ...
      <PlanStorageContainer>
        <PlanStorageDivider />
        <PlanStorageText>2 TB Storage</PlanStorageText>
        <PlanStorageDivider />
        <PlanStorageText>10 Users Allowed</PlanStorageText>
        <PlanStorageDivider />
        <PlanStorageText>Send up to 20 GB</PlanStorageText>
        <PlanStorageDivider />
      </PlanStorageContainer>
