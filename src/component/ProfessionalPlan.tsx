...
export const ProfessionalPlanComponent = ({ pricing }: { pricing: string }) => {
  return (
    <ProfessionalPlan>
      <MasterTitle>Professional</MasterTitle>
      <PlanPriceContainer>
      ...
      <PlanStorageContainer>
        <PlanStorageDivider />
        <PlanStorageText>1 TB Storage</PlanStorageText>
        <PlanStorageDivider />
        <PlanStorageText>5 Users Allowed</PlanStorageText>
        <PlanStorageDivider />
        <PlanStorageText>Send up to 10 GB</PlanStorageText>
        <PlanStorageDivider />
      </PlanStorageContainer>
